      ...
      <el-container>
        <el-header class="header" style="caret-color: rgba(0, 0, 0, 0);">
          <div class="header-content">
            <div class="sj-button">
              <span @click="sj" style="cursor: pointer"><el-icon><DArrowLeft/></el-icon></span>
              <span style="margin-left: 50px;"><a :href="serverIndexUrl" target=_blank><img
                  src="../../assets/zhangdian.png" style="width: 20px;"/></a></span>
              <span style="margin-left: 20px;"><a href="https://github.com/Yepeng-hup/flask-vue-errShare.git"><img
                  src="../../assets/github.png" style="width: 20px;"/></a></span>
            </div>
            <div>
                  ...
                  <el-dropdown-menu>
                    <el-dropdown-item>
                      <el-menu
                          ...
                          :router="true"
                      >
                        <el-menu-item style="padding: 0px; height: 25px;;" index="1" :route="{name: 'UserCenterView'}">
                          <span class="hover-text">个人设置</span>
                        </el-menu-item>
                      </el-menu>
                    </el-dropdown-item>
                    <el-dropdown-item>
